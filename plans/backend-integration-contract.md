...
> Status: future-facing integration contract. No backend, Supabase project, API, CLI, agent runtime, or credentials are to be added by this document.
>
> Last updated: 2026-08-14. Current frontend remains Vite + React + Tailwind with static in-memory data.
...
- Do not require Supabase, React Router, Redux, or a backend for unrelated UI documentation or visual work.
